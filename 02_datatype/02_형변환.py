...
# iterarive / 집합적 자료 / sequence : 리스트, 딕셔너리, 튜플, 세트
...
print('oct(0b110101)=', oct(0b11010111))
print('oct(0x123)=', oct(0x123))

print('hex(123)=', hex(123))
print('hex(0b110101)=', hex(0b11010111))
...
# 2) 형변환
# int(string), float(string), string(numer)
...
name = input('이름은:')
year = input('출생연도는:')
print(f'이름은 {name}, 나이는 {2024-int(year)}')
...
# 문제 1. 두 정수를 입력받아서 합계 출력
num1 = int(input('정수1 = '))
num2 = int(input('정수2 = '))
print(f'{num1} + {num2} = {num1+num2}')

# 문제 2. 몸무게와 키 값을 입력받아서 BMI 지수 계산
# BMI = 몸무게 / 키의 제곱
w = float(input('몸무게(킬로그램) : '))
h = float(input('키(미터) : '))
BMI = w / (h**2)
